...
def load_model():
    ...
    return h2o.load_model(os.path.join(BASE_DIR, "GLM_1_AutoML_2_20260408_210958"))
...
# ── Main Layout ──────────────────────────────────────────────
col_left, col_right = st.columns([0.9, 1.1], gap="medium")
...
if predict_btn:
    ...
    with st.spinner("Computing SHAP values…"):
        try:
            ...
            bg_df = pd.read_csv(os.path.join(BASE_DIR, "background.csv"))
